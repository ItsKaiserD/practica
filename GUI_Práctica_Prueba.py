...
button_add = Button(window, text="+", padx=39, pady=20, command=button_click)
button_equal = Button(window, text="=", padx=91, pady=20, command=button_click)
button_clear = Button(window, text="Limpiar", padx=79, pady=20, command=button_click)


#Widget Label o de Texto 
